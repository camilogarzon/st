...
function conexiones($usuario, $clave) {
	...
	$conectar = mysql_connect('localhost','dba_interfirex','123456');
	//seleccionar la base de datos para trabajar
	mysql_select_db('interfirex',$conectar);
	//sentencia sql para consultar el nombre del usuario
	$sql = "SELECT * FROM `interfirex`.`usuarios` WHERE `usuario`='$usuario' AND `psw`='$clave'";
