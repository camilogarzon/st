         ...
         <!-- ARTICULOS -->
         	...
         	<div id="tabs" class="tabs2">
                <ul>
                    ...
                    <li><a href="#tabs-4">Pruebas y mantenimieto</a></li>
                </ul>
                <div id="tabs-1">
                
                <!-- INICIO REGISTRO ROCIADORES --><!-- INICIO REGISTRO ROCIADORES --><!-- INICIO REGISTRO ROCIADORES -->
                
                <h1 class="pageTitle">Sistemas fijos de Extinci&oacute;n por Polvo</h1>
                   ...
                   <div class="form_default">
                    ...
                    <p>
	                   ...
	                   <fieldset><legend>tipo de agente extintor</legend>
                    <p>
                    ...
                    <p>
                        ...
                        <div class="three_fourth last"><input type="text" name="name" class="sftable" />
                        </div>
                    </p>
	                   </fieldset>
                ...
                <h1 class="pageTitle">Sistema fijos de extincion por polvo</h1>
                ...
                <h1 class="pageTitle">Sistemas fijos de extincion por polvo</h1>
                   ...
                   <div class="form_default">
			        ...
			        <div class="sTableWrapper">
			            <table cellpadding="0" cellspacing="0" class="sTable" width="100%">
			                ...
			                <tr>
			                    <td>Comprobar que los riesgos no han cambiado</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option></select></td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option></select></td>
			                </tr>
			                <tr>
			                ...
			                <tr>
			                    <td>Comprobar que los accesorios de union no han sufrido daños o cambios </td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option></select></td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option></select></td>
			                </tr>
			                <tr>
			                ...
			                <tr>
			                    <td>Comprobar que los dispositivos de señalizacion no han sufrido daños o cambios </td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option></select></td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option></select></td>
			                </tr>
			                <tr>
			                ...
			                <tr>
			                    <td>Reemplazar el eslabon fusible (anualmente)</td>
			                    <td>N/A</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option></select></td>
			                </tr>
			            </table>
                ...
                <h1 class="pageTitle">Sistemas fijos de Extinci&oacute;n por Polvo</h1>
                   ...
                   <div class="form_default">
                    ...
                    <p>
                    	<div class="one_sixth"><label for="name">Fecha de la prueba de funcionamiento (Semestral)</label></div>
                        ...
                        <div class="one_sixth"><label for="name">Eslabon fisible</label></div>
                     ...
                     <p>
                      ...
                      <p>
                       ...
                       <p>
                       <div class="one_sixth"><label for="name">Conexion con el sistema de extraccion de gases para desconexion automatica</label></div>
                        <div class="one_sixth"><select name="occupation"><option>Seleccione una</option><option value="0">Si</option><option value="1">No </option></select></div>
                        <div class="one_sixth"><label for="name">Resultados</label></div>
                        <div class="one_sixth last"><select name="occupation"><option>Seleccione una</option><option value="0">Satisfactorio</option><option value="1">No Satisfactorio</option></select></div>
                        </p>
                    ...
                    <p>
                       ...
                       <p>
                       <div class="one_sixth"><label for="name">Conexion para desconectar lo aparatos electricos debajo de la campana</label></div>
                        <div class="one_sixth"><select name="occupation"><option>Seleccione una</option><option value="0">Si</option><option value="1">No </option></select></div>
                        <div class="one_sixth"><label for="name">Resultados</label></div>
                        <div class="one_sixth last"><select name="occupation"><option>Seleccione una</option><option value="0">Satisfactorio</option><option value="1">No Satisfactorio</option></select></div>
                        </p>
                    ...
                    <p>
                    	<div class="one_fourth"><label for="name">Presion de los cilindros</label></div>
                        <div class="one_fourth"><select name="occupation"><option>Seleccione una</option><option value="0">Si</option><option value="1">No</option></select></div>
                        <div class="one_fourth"><label for="name">Camara de polvo</label></div>
                    ...
                    <p>
                    	<div class="one_fourth"><label for="name">Cilindros de presion auxiliar</label></div>
                        <div class="one_fourth"><select name="occupation"><option>Seleccione una</option><option value="0">Si</option><option value="1">No</option></select></div>
                        <div class="one_fourth"><label for="name">Union de valvulas</label></div>
                        <div class="one_fourth last"><select name="occupation"><option>Seleccione una</option><option value="0">Si</option><option value="1">No</option></select></div>
                        </p>
                    </p>
                    <p>
                    	<div class="one_fourth"><label for="name">Mangueras y accesorios</label></div>
                        <div class="one_fourth"><select name="occupation"><option>Seleccione una</option><option value="0">Si</option><option value="1">No</option></select></div>
                        <div class="one_fourth"><label for="name">Valvulas de retencion</label></div>
                        <div class="one_fourth last"><select name="occupation"><option>Seleccione una</option><option value="0">Si</option><option value="1">No</option></select></div>
                        </p>
                    <p>
                    	<div class="one_fourth"><label for="name">Valvulas direccionales</label></div>
                        <div class="one_fourth"><select name="occupation"><option>Seleccione una</option><option value="0">Si</option><option value="1">No</option></select></div>
                        <div class="one_fourth"><label for="name">Colectores</label></div>
                        <div class="one_fourth last"><select name="occupation"><option>Seleccione una</option><option value="0">Si</option><option value="1">No</option></select></div>
                        </p>
	                   </fieldset>
