         ...
         <!-- ARTICULOS -->
         	...
         	<div id="tabs" class="tabs2">
                <ul>
                    ...
                    <li><a href="#tabs-4">Rev. Semestral</a></li>
                    <li><a href="#tabs-5">Rev. Anual</a></li>
                    <li><a href="#tabs-6">Rev. Quiquenal</a></li>
                </ul>
                ...
                <h1 class="pageTitle">Sistemas de Agua Pulverizada</h1>
                   ...
                   <div class="form_default">
                    ...
                    <p>
	                   ...
	                   <fieldset><legend>Instrucciones de manejo</legend>
                    <p>
		            ...
		            <p>
	                   ...
	                   <!-- TABLA MENSUAL -->
			            ...
			            <tr>
			                <td>Fecha</td>
			                <td>Inspector</td>
			                <td>Valvulas abiertas</td>
			                <td>inspeccionar boquillas</td>
			            </tr>
			            </table>
                   ...
                   <div class="form_default">
			        ...
			        <div class="sTableWrapper">
			            <table cellpadding="0" cellspacing="0" class="sTable" width="100%">
			                ...
			                <tr>
			                    <td>Prueba de caudal</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Si</option><option value="1">No</option></select></td>
			                </tr>
			                <tr>
			                <tr>
			                    <td>Patron de descarga</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Si</option><option value="1">No</option></select></td>
			                </tr>
			                <tr>
			                    <td>Valvula de diluvio</td>
			                ...
			                <tr>
			                    <td>Comparar los resultados de la pueba de este año con los resultados de años anteriores para determinar si el suministro de agua se ha deteriorado</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Si</option><option value="1">No</option></select></td>
			                </tr>
			                <tr>
			                    <td>Alarma por baja temperatura</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Si</option><option value="1">No</option></select></td>
			                </tr>
			                <tr>
