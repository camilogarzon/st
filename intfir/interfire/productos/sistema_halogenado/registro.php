<form action="" method="post">
                   <div class="form_default">
                    ...
                    <p>
                    	<div class="one_sixth"><label for="name">Localización del Sistema</label></div>
                    	<div class="one_sixth "><input type="text" name="name"  class="sftable" /></div>
                    	<div class="one_sixth"><label for="name">Fabricante del detector</label></div>
                    	<div class="one_sixth "><input type="text" name="name"  class="sftable" /></div>
                    ...
                    <p>
                    	...
                    	<div class="one_sixth"><label for="name">Contrato de mantenimiento</label></div>
                    	<div class="one_sixth last"><input type="text" name="name" class="sftable" /></div>
                    </p>
	                   </fieldset>
