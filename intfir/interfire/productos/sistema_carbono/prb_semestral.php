                   ...
                   <div class="form_default">
			        ...
			        <div class="sTableWrapper">
			            <table cellpadding="0" cellspacing="0" class="sTable" width="100%">
			                ...
			                <tr>
			                    <td>Peso (lb) (Una perdida de mas del 10% requiere rellenado)</td>
			                    <td><input type="text" name="email" value="lb"  class="sftablehalf" /><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option></select></td>
			                </tr>
			                <tr>
			                    <td>La válvula de control esta operativa</td>
