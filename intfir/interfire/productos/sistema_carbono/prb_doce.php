                   ...
                   <div class="form_default">
		            ...
		            <p>
                        ...
                        <div class="one_sixth last"><select name="occupation"><option>Seleccione una</option><option value="0">Instalaci&oacute;n</option><option value="1">Dise&ntilde;o</option><option value="2">Auditor&iacute;a</option><option value="3">Interventor&iacute;a</option><option value="4">IPM</option></select></div>
	                  	...
	                  	<fieldset>
	                   	<legend>Pruebas y Mantenimiento a los 12 A–os</legend>
			        ...
			        <div class="sTableWrapper">
			            <table cellpadding="0" cellspacing="0" class="sTable" width="100%">
			                ...
			                <tr>
			                    <td>Prueba hidrostatica de los cilindros ÀA realizar este a–o?</td>
			                ...
			                <tr>
			                    <td>ÀPrueba realizada? (en caso afirmativo, dar datos)</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option></select></td>
			                </tr>
			                    <td>Inspector</td>
			                    <td><input type="text" name="email" value="precargado" class="sftable" /></td>
			                ...
			                <tr>
			                    <td>Prueba de descarga del sistema ÀA realizar este a–o?</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option></select></td>
			                </tr>
			                <tr>
			                    <td>ÀPrueba realizada? (en caso afirmativo, dar datos)</td>
			                    ...
			                    <td>ÀPrueba satisfactoria?(en caso afirmativo, dar datos; si no, explicar debajo)</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option></select></td>
			                </tr>
			            </table>
			        </div>
