                   ...
                   <div class="form_default">
			        ...
			        <div class="sTableWrapper">
			            <table cellpadding="0" cellspacing="0" class="sTable" width="100%">
			                ...
			                <tr>
			                <tr>
			                    <td>Inspeccionar los terminales de las baterías para asegurarse de que están limpios y bien apretados</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option><option value="2">N/A</option></select></td>
			                <tr>
			                <tr>
			                    <td>Inspeccionar el estado del cableado donde pueda estar sometido a fricción</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option><option value="2">N/A</option></select></td>
			                <tr>
			            </table>
			        </div>
