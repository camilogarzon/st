                   ...
                   <div class="form_default">
			        ...
			        <div class="sTableWrapper">
			            <table cellpadding="0" cellspacing="0" class="sTable" width="100%">
			                ...
			                <tr>
			                    <td>Se ha inspeccionado el respiradero del carter?</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Si</option><option value="1">No</option></select></td>
			                <tr>
			                <tr>
			                    <td>Se ha inspeccionado el aislamiento del escape?</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Si</option><option value="1">No</option></select></td>
			                <tr>
			                <tr>
			                    <td>Se ha inspeccionado los terminales de las baterías para asegurarse de que están limpios y bien apretados?</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Si</option><option value="1">No</option></select></td>
			                <tr>
			                <tr>
			                    <td>Se ha inspeccionado el estado del cableado donde pueda estar sometido a fricción?</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Si</option><option value="1">No</option></select></td>
			                <tr>
			            </table>
			        </div>
