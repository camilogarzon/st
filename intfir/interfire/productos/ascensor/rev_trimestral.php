                   ...
                   <div class="form_default">
			        ...
			        <div class="sTableWrapper">
			            <table cellpadding="0" cellspacing="0" class="sTable" width="100%">
			                ...
			                <tr>
			                    <td>Probar el paro de emergencia del ascensor</td>
			                    <td><input type="text" name="email" class="sftable" /></td>
			                </tr>
			                <tr>
			                    <td>Probar los detectores del cuarto tecnico</td>
			                    <td><input type="text" name="email" class="sftable" /></td>
			                </tr>
			                <tr>
			                    <td>Prueba de apertura de puertas en emergencia</td>
			                    <td><input type="text" name="email" class="sftable" /></td>
			                </tr>
			                <tr>
			                    <td>Probar comunicación de emergencia</td>
			                    <td><input type="text" name="email" class="sftable" /></td>
			                </tr>
			                <tr>
			                    <td>Probar generador eléctrico </td>
			                    <td><input type="text" name="email" class="sftable" /></td>
			                </tr>
			            </table>
