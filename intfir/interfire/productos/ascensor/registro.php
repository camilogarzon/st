<form action="" method="post">
                   <div class="form_default">
		            ...
		            <p>
	                   ...
	                   <fieldset><legend>Ascensor de Emergencia</legend>
                     <p>
                    ...
                    <p>
                    	<div class="one_fourth"><label for="name">Instalado por</label></div>
                    	<div class="one_fourth"><input type="text" name="name"  class="sftable" /></div>
                    	<div class="one_fourth"><label for="name">Fecha de instalaci—n</label></div>
                    	<div class="one_fourth last"><input type="text" name="name"  class="sftable" /></div>
                    </p>
                    <p>
                    	<div class="one_fourth"><label for="name">El ascensor est‡ listado y aprobados UL/FM</label></div>
                    	...
                    	<div class="one_fourth"><label for="name">Se realizaron pruebas de aceptaci—n</label></div>
                    ...
                    <p>
                    	<div class="one_fourth"><label for="name">Fecha de œltimo mantenimiento</label></div>
                    	<div class="one_fourth"><input type="text" name="name"  class="sftable" /></div>
                    </p>
	                   </fieldset>
