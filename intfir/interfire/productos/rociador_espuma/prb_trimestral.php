                   ...
                   <div class="form_default">
		            ...
		            <p>
	                   ...
	                   <!-- TABLA TRIMESTRAL-->
	                  	...
	                  	<fieldset>
	                   	<legend>Pruebas Trimestrales</legend>
			        ...
			        <div class="sTableWrapper">
			            <table cellpadding="0" cellspacing="0" class="sTable" width="100%">
			                ...
			                <tr>
			                    <td>Inspecciónar los filtros de espumogeno</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Si</option><option value="1">No</option></select></td>
			                </tr>
			                <tr>
			                    <td>Inspecciónar el área próxima al sistema de espuma para asegurar un drenaje correcto</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Si</option><option value="1">No</option></select></td>
			                </tr>
			                <tr>
			                    <td>Inspecciónar el sistema de tuberías y accesorios para ver si existe corrosión, falta de alineación, secciones bloqueadas, estado de los puntos de drenaje y de las juntas de goma</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Si</option><option value="1">No</option></select></td>
			                </tr>
			                <tr>
			                    <td>Inspecciónar los soportes para ver si están dañados o le faltan elementos, si esta correctamente sustentada, oxidada, con signos de corrosión o con el revestimiento dañado</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Si</option><option value="1">No</option></select></td>
			                </tr>
			            </table>
