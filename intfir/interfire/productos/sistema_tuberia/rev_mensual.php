<form id="inspeccion_mensual_tuberia_mangueras">
    <script type="text/javascript">
        var form_inspeccion_mensual_ = 'inspeccion_mensual_tuberia_mangueras';
        ...
        jQuery(document).ready(function() {
            ...
            applyDatepicker('inspeccion_mensual_campo01');
        ...
        function inspeccion_mensual_savedata() {
            ...
            if (fecha != '') {
                var sist = jQuery('#inspeccion_mensual_sistema').val();
                ...
                ladata = "op=evaluacion_save&sdid=" + sdid + "&pronum=" + pronum + "&usrid=" + usrid + "&id=" + evaid + "&form=" + form_inspeccion_mensual_ + "&fecha=" + fecha+"&sist="+sist + "&activ=" + activ + "&content=" + jsonstr + "&nota=" + nota;
    ...
    <div class="form_default">
        ...
        <fieldset>
            ...
            <div class="one_sixth"><input type="text" id="inspeccion_mensual_sistema"  class="sftable" /></div>
        ...
        <fieldset>
            ...
            <div class="sTableWrapper">
                <table cellpadding="0" cellspacing="0" class="sTable" width="100%">
                    ...
                    <tr>
                        <td><input id="inspeccion_mensual_campo01" type="text" name="email" value="fecha" class="sftable" /></td>
                        <td><input id="inspeccion_mensual_campo02" type="text" name="email" value="precargado" class="sftable" /></td>
                        <td><input id="inspeccion_mensual_campo03" type="text" name="email" class="sftable" /></td>
                        <td><select id="inspeccion_mensual_campo04"><option value="seleccione">Seleccionar</option><option value="0">Si</option><option value="1">No</option></select></td>
                    </tr>
                </table>
