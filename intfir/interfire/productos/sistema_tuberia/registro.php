<form action="" method="post">
                   <div class="form_default">
                    ...
                    <p>
                    	<div class="one_fourth"><label for="name">Existen boquillas de cierre automático</label></div>
                    	...
                    	<div class="one_fourth"><label for="name">Existen dispositivos reguladores de presión</label></div>
                    ...
                    <p>
                    	<div class="one_fourth"><label for="name">Tipo de los dispositivos reguladores de presión</label></div>
                    ...
                    <p>
                        ...
                        <div class="one_fourth"><select name="occupation"><option>Seleccione una</option><option value="0">Precintadas</option><option value="1">Bloqueadas</option><option value="2">Interruptor antimanipulacioón</option></select></div>
	                ...
	                <p>
                    	...
                    	<div class="one_sixth"><label for="name">Cuando se Inspecciónaron las bombas por &uacute;ltima vez?</label></div>
