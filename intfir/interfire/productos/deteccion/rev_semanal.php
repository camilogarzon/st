                   ...
                   <div class="form_default">
			        ...
			        <div class="sTableWrapper">
			            <table cellpadding="0" cellspacing="0" class="sTable" width="100%">
			                ...
			                <tr>
			                    <td>El equipo de control para sistemas de alarma de incendios sin localización de alarmas, supervisión ni señales de averías</td>
			                ...
			                <tr>
			                    <td>Suministro principal de energía</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option><option value="2">No Aplica</option></select></td>
			                </tr>
			            </table>
