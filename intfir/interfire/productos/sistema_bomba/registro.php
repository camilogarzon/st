<form action="" method="post">
                   <div class="form_default">
                    ...
                    <p>
                        <div class="one_fourth"><label for="name">Fecha</label></div>
                    ...
                    <p>
                    	<div class="one_fourth"><label for="name">Cabezal de prueba</label></div>
                        <div class="one_fourth">
	                        <select name="occupation">
	                          <option>Seleccione una</option>
	                          <option value="0">Si</option>
                        ...
                        <div class="one_fourth"><label for="name">No. de boquillas</label></div>
                    ...
                    <p>
                        ...
                        <div class="one_fourth"><label for="name">Velocidad (rpm)</label></div>
                        <div class="one_fourth last"><input type="text" name="name" value="numerador" class="sftable" /></div>
                    </p>
                    <p>
                        <div class="one_fourth"><label for="name">Voltaje</label></div>
                        <div class="one_fourth"><input type="text" name="name" value="numerador" class="sftable" /></div>
                        <div class="one_fourth"><label for="name">Amperaje</label></div>
                        <div class="one_fourth last"><input type="text" name="name" value="numerador" class="sftable" /></div>
                    </p>
                    <p>
                        <div class="one_fourth"><label for="name">Face</label></div>
                        <div class="one_fourth"><input type="text" name="name" value="numerador" class="sftable" /></div>
                        <div class="one_fourth"><label for="name">FS</label></div>
                        <div class="one_fourth last"><input type="text" name="name" value="numerador" class="sftable" /></div>
                    </p>
	                   </fieldset>
