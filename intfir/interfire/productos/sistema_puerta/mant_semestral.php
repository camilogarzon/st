			        ...
			        <div class="sTableWrapper">
			            <table cellpadding="0" cellspacing="0" class="sTable" width="100%">
			                ...
			                <tr>
			                    ...
			                    <td><select name="occupation"><option>Sel</option><option value="0">SI</option><option value="1">NO</option></select></td>
			                </tr>
			                <tr>
			                ...
			                <tr>
			                    <td>3. Engrasar todas las partes moviles para asegurar su correcto funcionamiento</td>
			                    <td><select name="occupation"><option>Sel</option><option value="0">SI</option><option value="1">NO</option></select></td>
			                </tr>
			            </table>
