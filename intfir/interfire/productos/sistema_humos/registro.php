<form action="" method="post">
                   <div class="form_default">
                    ...
                    <p>
                    	<div class="one_fourth"><label for="name">Todos los ventiladores impulsan aire en la dirección correcta</label></div>
                    	...
                    	<div class="one_fourth"><label for="name">Calibración de velocidad</label></div>
                    ...
                    <p>
                        ...
                        <div class="one_fourth "><select name="occupation"> <option>Seleccione una</option><option value="0">Si</option> <option value="1">No</option></select></div>
                        <div class="one_fourth"><label for="name">Se realizaron las pruebas de aceptación del sistema</label></div>
