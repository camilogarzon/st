                   ...
                   <div class="form_default">
			        ...
			        <div class="sTableWrapper">
			            <table cellpadding="0" cellspacing="0" class="sTable" width="100%">
			                ...
			                <tr>
			                    <td>Verificar la localización del perimetro de cada zona de control de humos</td>
                            ...
                            <tr>
			                    <td>Confirmar que todas las puertas de la zona de control de humos están cerradas</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option></select></td>
			                    <td><input type="text" name="email"  class="sftable" /></td>
			                </tr>
                            <tr>
			                    <td>Medir y registrar la diferencia de presión entre ambos lados de la barrera de control de humos (en cada puerta o cada par de puertas)</td>
			                    <td><select name="occupation"><option>Seleccionar</option><option value="0">Correcto</option><option value="1">Incorrecto</option></select></td>
			                    <td><input type="text" name="email"  class="sftable" /></td>
			                </tr>
			            </table>
			        ...
			        <div class="sTableWrapper">
                       ...
                       <fieldset>
	                   	<legend>Recepción de Puerta</legend>
