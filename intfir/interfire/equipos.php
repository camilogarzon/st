            ...
            <tbody>
                <?php for ($i = 0; $i < count($arrequipos); $i++) { ?>
                    <tr class="gradeC">
                        ...
                        <td class="con1"><a target="_blank" href="https://chart.googleapis.com/chart?chs=200x200&cht=qr&chl=http://interfiresas.com/interfire/<?php echo $arrequipos[$i]['href']."?id=".$arrequipos[$i]['numinventario']; ?>">QR</a></td>
                    </tr>
                <?php } ?>
<!--                
                <tr class="gradeC">
            ...
            <tfoot>
                <tr>
                    ...
                    <th class="head0">Fecha Creación</th>
                    <th class="head1">QR</th>
                </tr>
            </tfoot>
        </table>
